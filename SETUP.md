...
# Nur Originaltitel/-optionen; Lücken bleiben unausgefüllt.
# Fehlende Protokoll-Schlüssel: python3 website/scripts/apply-h25-ai-keys.py
# (schreibt KI-Lösungen, überschreibt keine Protokoll-Markierungen)
